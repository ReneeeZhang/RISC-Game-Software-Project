...
public class ClientInstructionCheckerTest {
    ...
    public void isValid() {
        ...
        ClientInstructionChecker clientInstructionChecker = new ClientInstructionChecker(instructions);
        Assertions.assertTrue(clientInstructionChecker.isValid());
        //lacking units test
        when(m2.getNumUnit()).thenReturn(4);
        ClientInstructionChecker clientInstructionChecker2 = new ClientInstructionChecker(instructions);
        ...
        ClientInstructionChecker clientInstructionChecker3 = new ClientInstructionChecker(instructions2);
